...
var illustratedGuideModelDatas:[IllustratedGuide] =
    [
        IllustratedGuide(level: 1, guideImage: UIImage(named: "chip-34 1")!, name: "碳員", title: "新手碳教學", iconImage: UIImage(named:"level1-icon")!, guide: "碳固定是生物將無機碳（二氧化碳） 轉換為有機化合物的過程。"),
        IllustratedGuide(level: 2, guideImage: UIImage(named: "Group 174")!, name: "割草雞", title: "堆肥", iconImage: UIImage(named: "chi-15 1")!, guide: "堆肥是被分解和回收的有機物質作為肥料和土壤調理劑。堆肥是有機農業的關鍵成分。"),
        IllustratedGuide(level: 3, guideImage: UIImage(named: "Group 175")!, name: "潛水雞", title: "水資源", iconImage: UIImage(named: "")!, guide: "全球的水資源只有少於2.5%是淡水，其餘的都是海水。"),
